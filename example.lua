function f1.f2.f3:f4(a1,a2)
    local function locally_sourced(a11,a22) end
    a, b = function(abcdefg,hijkl) end, function(see,me,last) end
end
...
function Trainer:train(epoch, dataloader)
   ...
   print(('=> Training epoch # ' .. epoch):format("bullshit"))
